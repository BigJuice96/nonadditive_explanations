...
simulation_results_for_chi_square.to_csv("/Users/abdallah/Desktop/Kings College Project/Code/results/exp2_simulation_results_for_chi_square2.csv") #TODO i gave this the 2 suffix to check it first before deleting the other 

    # Now refer to R file for simulation evaluation
