...
# SVSL
exp2_SVSL_nsamples500_ntotal2000_binary_False_PLOT <- read.csv("/Users/abdallah/Desktop/Kings College Project/Code/results/exp2_SVSL_nsamples500_ntotal2000_binary_False_PLOT.csv")
...
p <- ggarrange(p1_SurvLIME, p2_SurvSHAP, p3_SVSL, ncol=3, nrow=1, common.legend = TRUE, legend="bottom") +
